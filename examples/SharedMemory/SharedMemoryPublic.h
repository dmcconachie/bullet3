...
enum EnumSharedMemoryClientCommand
{
	...
	CMD_LOAD_MJCF,
	CMD_LOAD_SOFT_BODY,
	CMD_CREATE_CLOTH_PATCH_OBJ_FILE,
	CMD_GENERATE_CLOTH_PATCH_DIAGONAL_LINKS,
	CMD_UPDATE_SOFT_BODY_PARAMETERS,
...
enum EnumSharedMemoryServerStatus
{
	...
	CMD_CREATE_CLOTH_PATCH_OBJ_FILE_FAILED,
	CMD_CREATE_CLOTH_PATCH_OBJ_FILE_COMPLETED,
